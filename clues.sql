...
-- Write SQL query here
SELECT c.*, cl.language, cl.isofficial, cl.percentage
FROM countries c
JOIN countrylanguages cl
ON c.code = cl.countrycode
WHERE cl.language = 'Italian' AND cl.isofficial = 't' AND cl.percentage = 100
...
-- Write SQL query here
SELECT * FROM cities WHERE name LIKE 'Serr%' AND NOT countrycode = 'SMR';
...
-- Write SQL query here
SELECT c.code, c.capital, ci.id, ci.name
FROM countries c
